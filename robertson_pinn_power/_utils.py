...
def plot_pinn_y(x_pinn, y_pinn, t_true, y_true,
    ...
    for i in range(len(species_names)):
        ...
        ax2.set_xlim(left=xlim_left)
        ax2.set_xscale('log')
        ax2.set_title(species_names[i])
        ax2.legend(loc='upper left', shadow=False, framealpha=0.5)
    ...
    fig.savefig(figname, dpi=120, facecolor='w',
